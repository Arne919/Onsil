<template>
  <div class="create-post-page">
    ...
    <form @submit.prevent="createUpdatePost" class="post-form">
      ...
      <button v-else-if="route.name === 'postUpdate'" class="submit-button">게시글 수정</button>
    </form>
  </div>
</template>
...
const createUpdatePost = function () {
  if ( route.name === 'postCreate' ) {
    const post = {
      title: title.value,
